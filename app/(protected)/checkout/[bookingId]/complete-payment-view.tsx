      ...
      <Card>
        <CardContent className="pt-6">
          <div className="space-y-4">
            ...
            <div className="bg-amber-50 text-amber-800 p-4 border border-amber-200 rounded-lg text-sm">
            ...
            <div className="flex justify-between items-center py-4 border-t">
              <div>
                ...
                <p className="text-2xl font-bold">${Number(booking.total_amount ?? 0).toLocaleString()} USD</p>
              </div>
